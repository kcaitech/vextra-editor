...
export function canNotBeApex(shape: Shape): boolean { // 可以被判定为检索结果的前提是没有被锁定和isVisible可视
    return shape.isVirtualShape || !shape.getVisible() || shape.isLocked || shape.type === ShapeType.Contact;
}
