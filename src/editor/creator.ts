...
import { ExportOptions, ShapeFrame, GroupShape, ShapeType, BoolOp, Shape } from "@/data/shape";
import { BorderOptions, ContextSettings, BlendMode, Style, MarkerType, WindingRule } from "@/data/style";
