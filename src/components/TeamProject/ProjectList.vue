...
import { Ref, computed, inject, onMounted, ref, watch, watchEffect } from 'vue';
...
console.log(updateprojectlist.value);
...
//         SearchList.value = teamprojectlist.value.filter((el: any) => {
