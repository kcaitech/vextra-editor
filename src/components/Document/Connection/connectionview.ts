...
export class ConnectionLineView extends PathShapeView {
...
/* 获取连接线的端点图层以及端点位置 */
function getContactForm(page: PageView, view: ConnectionLineView, contactForm: ContactForm | undefined) {
...
function path_for_free_end_contact(shape: ConnectionLineView, points: CurvePoint[], start: {
    x: number,
    y: number
} | undefined) {
    if (!start) {
