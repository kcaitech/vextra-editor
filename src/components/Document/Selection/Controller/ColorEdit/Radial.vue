...
import { AsyncGradientEditor, BasicArray, Color, GradientType, GroupShapeView, Matrix, ShapeFrame, ShapeType, ShapeView, Stop, TableCell, TableView, TextShapeView, adapt2Shape, cloneGradient } from '@kcdesign/data';
