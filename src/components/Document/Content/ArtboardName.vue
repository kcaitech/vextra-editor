...
>
    ...
    >
        <svg v-if="(data.shape as SymbolView).isSymbolUnionShape" xmlns="http://www.w3.org/2000/svg" fill="none"
            ...
            <g>
                <path
                    ...
                    fill-rule="evenodd" fill="#7F58F9"/>
            </g>
            <g transform="matrix(0.7071067690849304,0.7071067690849304,-0.7071067690849304,0.7071067690849304,4.538494595686643,-4.75560098247297)">
                <rect x="8.009765625" y="3.10064697265625" width="3" height="3" rx="0.5" fill="#B7A4F3"/>
            </g>
            <g transform="matrix(0.7071067690849304,0.7071067690849304,-0.7071067690849304,0.7071067690849304,5.693277989414128,-1.9677502472059132)">
                <rect x="5.221923828125" y="5.888519287109375" width="3" height="3" rx="0.5" fill="#B7A4F3"/>
            </g>
            <g transform="matrix(0.7071067690849304,0.7071067690849304,-0.7071067690849304,0.7071067690849304,7.306647318680916,-5.902135808926687)">
                <rect x="10.77783203125" y="5.86883544921875" width="3" height="3" rx="0.5" fill="#B7A4F3"/>
            </g>
            <g transform="matrix(0.7071067690849304,0.7071067690849304,-0.7071067690849304,0.7071067690849304,8.461502219544855,-3.1144577071481763)">
        ...
        <svg v-if="(data.shape.type === ShapeType.Symbol)" xmlns="http://www.w3.org/2000/svg"
            ...
            <g transform="matrix(0.7071067690849304,0.7071067690849304,-0.7071067690849304,0.7071067690849304,4.540654637874468,-4.75025670389914)">
    ...
    <input
        ...
        @mousedown.stop
    />
    <span v-if="isInput" ref="inputSpan" style="position: absolute; visibility: hidden;  top: 0;"/>
</div>
</template>
