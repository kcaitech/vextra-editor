<template>
    <div class="wrap">
        <div class="title" :style="{height: (show && !searchvalue) ? '116px' : '36px'}">
            <div class="left">
                <span>{{ t('home.recently_opened') }}</span>
                <div
                    :style="{transform: `scaleY(${(!show && !searchvalue) ? 0 : 1})`, opacity:!show && !searchvalue? 0: 1 }"
                    class="newandopen">
            ...
            <div class="right"
                 :style="{opacity: (!show && !searchvalue) ? 1 : 0}">
                <div class="newfile" @click="newFile">
