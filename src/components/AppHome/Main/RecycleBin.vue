<template>
    <!-- 表格布局 -->
    <el-table :data="GetrecycleList || []" height="83vh" style="width: 100%" v-loading="isLoading" empty-text="没有内容" @row-click="toDocument">
                ...
                <el-icon :size=" 20 ">
                    <el-tooltip content="还原" show-after="1000">
                        <svg-icon class="svg restore" style="width: 20px; height: 20px;" icon-class="restore"
                            @click.stop=" Restorefile(scope.$index) "></svg-icon>
                    </el-tooltip>
                </el-icon>&nbsp;
                <el-icon :size=" 20 ">
